...
export declare class TNSCircleMenu extends NSObject {
    ...
    private _items;
    initMenu(items: Array<TNSCircleButton>, menuImage?: string, closeImage?: string, position?: CGRect, bgColor?: string): void;
    ...
    circleMenuButtonDidSelectedAtIndex(menu: any, button: any, atIndex: any): void;
}
